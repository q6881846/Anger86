...
console.log('Steps 6-8 updated successfully.');
console.log('Step 6 length:', data.step6.user.length);
console.log('Step 7 length:', data.step7.user.length);
console.log('Step 8 length:', data.step8.user.length);
